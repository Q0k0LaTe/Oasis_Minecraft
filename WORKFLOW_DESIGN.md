Here is a **clean, formal Markdown write-up** of your AI agent architecture, suitable for a **design doc / README / RFC**.
It captures the **Spec → IR → Execution** philosophy clearly and is aligned with real agent + compiler design.

---

# AI Agent Architecture for Minecraft Mod Generation

This document describes the architecture of an AI agent designed to generate Minecraft mods from natural-language user input. The system follows a **compiler-style pipeline**, separating *human intent* from *machine execution* to ensure reliability, determinism, and scalability.
...
It is a **compiler-driven agent system** that *happens* to use LLMs.
...
* a **minimal IR schema (MVP)**,
* a **tool registry design**,
* or a **Fabric-specific execution example**,

I can write that immediately.
